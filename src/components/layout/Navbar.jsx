      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="items-center flex-1 hidden ml-8 space-x-8 md:flex">
            <div className="flex items-center space-x-1 transition-colors cursor-pointer hover:text-gray-900">
        ...
        {isMobileMenuOpen && (
          <div className="absolute left-0 right-0 bg-white border-t border-gray-200 shadow-lg md:hidden top-16">
            <div className="px-4 py-3 space-y-3">
              ...
              <div className="space-y-3">
                ...
                <Button
                  size="default"
                  className="w-full h-12 text-white transition-colors bg-black hover:bg-gray-800"
                  onClick={() => {
